...
> Johannes Hentschel, Yannis Rammos, Markus Neuwirth, & Martin Rohrmeier. (2025). François Couperin – Concerts Royaux (A corpus of annotated scores) [Data set]. Zenodo. https://doi.org/{{ concept_doi }}
